...
Here's the Zoom link: https://pomonacollege.zoom.us/j/84767055724
...
- make a new class to handle everything about the wizard. You should start with an Init() method that pops it into the window
